...
function buildAccordionItem(topic, docs) {
...
export default async function decorate(block) {
  ...
  try {
    ...
    sampleRUM('error', { source: 'forms-accordion', target: err.message });
  }
}
